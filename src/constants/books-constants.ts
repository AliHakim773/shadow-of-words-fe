import shadowOfWords from '../assets/images/shadow-of-words.jpg';

const BOOKS = [
  {id: 'shadow-of-words',
  title_ar: 'ظلّ الكلمات',
  title_en: 'Shadow of Words',
  description_ar: 'كتاب «ظلّ الكلمات» يبحر في عوالم المشاعر والتأملات، حيث تنسج الكاتبة كلماتها لتكون مرآةً لروحٍ تتأمل الحياة وتفاصيلها بصدق ودفء. هو كتابٌ يُعانق القارئ بلغة وجدانية، يعبر عن خلجات القلب وأفكارٍ عميقة حول الحبّ، والذكريات، والإنسان، وعلاقته بخالقه وبمن حوله. في «ظلّ الكلمات»، تتحوّل الخواطر إلى ظلّ يرافق القارئ، يهمس له بحروفٍ نابضةٍ بالحياة ويترك أثرًا في روحه.',
